...
output "compute_environment_arns" {
  ...
  value       = module.batch_upscale.compute_environments
}
...
output "job_definition_arn" {
  ...
  value       = module.batch_upscale.job_definitions["upscale"].arn
}
...
output "job_queue_arn" {
  ...
  value       = module.batch_upscale.job_queues["upscale_queue"].arn
}
